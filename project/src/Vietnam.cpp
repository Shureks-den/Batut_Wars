...
void welcome_to_vietnam(World &world){
    ...
    auto blackhole_3 = std::unique_ptr<space::Massive>(new space::Massive(100, 125.0f));
    blackhole_3->set_position(sf::Vector2f(4000, 400));
    world.push_back(std::move(blackhole_3));
    auto blackhole_4 = std::unique_ptr<space::Massive>(new space::Massive(100, 125.0f));
    blackhole_4->set_position(sf::Vector2f(200, 3000));
    world.push_back(std::move(blackhole_4));
    auto blackhole_5 = std::unique_ptr<space::Massive>(new space::Massive(100, 125.0f));
    blackhole_5->set_position(sf::Vector2f(2000, 2000));
    world.push_back(std::move(blackhole_5));
    auto blackhole_6 = std::unique_ptr<space::Massive>(new space::Massive(100, 125.0f));
    blackhole_6->set_position(sf::Vector2f(3500, 3400));
    world.push_back(std::move(blackhole_6));
    auto blackhole_7 = std::unique_ptr<space::Massive>(new space::Massive(100, 125.0f));
    blackhole_7->set_position(sf::Vector2f(1000, 600));
    world.push_back(std::move(blackhole_7));
    auto blackhole_8 = std::unique_ptr<space::Massive>(new space::Massive(100, 125.0f));
    ...
    auto ice_planet_3 = std::unique_ptr<space::IcePlanet>(new space::IcePlanet(125.0f));
    ice_planet_3->set_position(sf::Vector2f(2000, 1000));
    world.push_back(std::move(ice_planet_3));
    auto ice_planet_4 = std::unique_ptr<space::IcePlanet>(new space::IcePlanet(125.0f));
    ice_planet_4->set_position(sf::Vector2f(3000, 3000));
    world.push_back(std::move(ice_planet_4));
    auto ice_planet_5 = std::unique_ptr<space::IcePlanet>(new space::IcePlanet(125.0f));
    ice_planet_5->set_position(sf::Vector2f(1456, 500));
    world.push_back(std::move(ice_planet_5));
    auto ice_planet_6 = std::unique_ptr<space::IcePlanet>(new space::IcePlanet(125.0f));
    ice_planet_6->set_position(sf::Vector2f(2666, 3500));
    world.push_back(std::move(ice_planet_6));
    auto ice_planet_7 = std::unique_ptr<space::IcePlanet>(new space::IcePlanet(125.0f));
    ice_planet_7->set_position(sf::Vector2f(400, 3500));
    world.push_back(std::move(ice_planet_7));
    auto ice_planet_8 = std::unique_ptr<space::IcePlanet>(new space::IcePlanet(125.0f));
    ...
    auto comet_7 = std::unique_ptr<space::Comet>(new space::Comet(engine::Vector(50, 50)));
    comet_7->set_position(sf::Vector2f(600, 3000));
    world.push_back(std::move(comet_7));
    auto comet_8 = std::unique_ptr<space::Comet>(new space::Comet(engine::Vector(100, -30)));
    comet_8->set_position(sf::Vector2f(2000, 540));
    world.push_back(std::move(comet_8));
    auto comet_9 = std::unique_ptr<space::Comet>(new space::Comet(engine::Vector(30, 30)));
    comet_9->set_position(sf::Vector2f(50, 600));
    world.push_back(std::move(comet_9));
    auto comet_10 = std::unique_ptr<space::Comet>(new space::Comet(engine::Vector(100, 100)));
    comet_10->set_position(sf::Vector2f(300, 666));
    world.push_back(std::move(comet_10));
    auto comet_11 = std::unique_ptr<space::Comet>(new space::Comet(engine::Vector(-50, 100)));
    comet_11->set_position(sf::Vector2f(2000, 1500));
    world.push_back(std::move(comet_11));
    auto comet_12 = std::unique_ptr<space::Comet>(new space::Comet(engine::Vector(0, 100)));
    comet_12->set_position(sf::Vector2f(2000, 2500));
    world.push_back(std::move(comet_12));
    auto comet_13 = std::unique_ptr<space::Comet>(new space::Comet(engine::Vector(100, -70)));
