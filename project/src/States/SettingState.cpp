...
SettingsState::SettingsState(StateStack& stack, Context context)
  ...
  add_button_label(Player::MOVE_LEFT, 150.f, "Rotate Left",
                   context);  // TODO(ANDY) позиция
  add_button_label(Player::MOVE_RIGHT, 200.f, "Rotate Right   ",
                   context);  // TODO(SOMEONE) пофиксить шрифты
